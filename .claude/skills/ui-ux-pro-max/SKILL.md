...
Set `SKILL_DIR` to this skill's base directory first (it is printed as "Base directory for this skill" when the skill loads; in this repo it is `.claude/skills/ui-ux-pro-max`):
...
# Step 3: supplement
python "$SKILL_DIR/scripts/search.py" "search loading animation" --domain ux
